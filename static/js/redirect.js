...
//
// It should be possible to do this with either HTML or server-side redirects,
// but it was never implemented or standardized. For reference:
//
...
function handleHash() {
    if (window.location.hash) {
        const redirect =
            redirects.get(window.location.pathname + window.location.hash);
        if (redirect) {
